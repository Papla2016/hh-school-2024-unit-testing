...
public class LibraryManagerTest {
  ...
  @Test
  void testIsThrowAnExceptionWhenAddNegativeBooks(){
    assertThrows(IllegalArgumentException.class,()->
        libraryManager.addBook("book3",-1)
    );//не должна ли кидаться ошибка, когда добавляется отрицательное количество книг?
  }
